%multiscale model output generated from adjusted transmission model and
...
%theoretical transmission models
% beta_v = c*(1 - exp(-0.2038*(V_log - 2 )));  %b1 transmission model Netherlands
% beta_v = c*(1-exp(-4.5518*(V_log-2).^6.047)); %b2 transmission model Netherlands
% beta_v = c*(1-exp(-1.8078*(V_log-2).^0.4181./((V_log-2).^0.4181+10^0.4181))); %b3 transmission model Netherlands
% beta_v = c*(1 - exp(-0.1824*(V_log - 2 )));  %b1 transmission model Usutu
% beta_v = c*(1-exp(-0.0042*(V_log-2).^3.4969)); %b2 transmission model Usutu
 beta_v = c*(1-exp(-1.581*(V_log-2).^1.6479./((V_log-2).^1.6479+10^1.6479))); %b3 transmission model Usutu
